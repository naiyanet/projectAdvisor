...
INSERT INTO STUDENT(ID,NAME,EMAIL,MOBILE,ADDRESS) 
        values(STUDENT_SEQ.nextVal,'somying','somyinggh@login.com','098888888','chonburi');

INSERT INTO STUDENT(ID,NAME,EMAIL,MOBILE,ADDRESS)
        values(STUDENT_SEQ.nextVal,'somchai','somchaigh@login.com','0988889999','bangkok');

INSERT INTO STUDENT(ID,NAME,EMAIL,MOBILE,ADDRESS) 
        values(STUDENT_SEQ.nextVal,'somruk','somruk@login.com','0988880000','bangkok');

INSERT INTO STUDENT(ID,NAME,EMAIL,MOBILE,ADDRESS)
        values(STUDENT_SEQ.nextVal,'naiyanet','naiyanet@login.com','0988880000','bangkok');
